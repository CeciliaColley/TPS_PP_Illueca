...
//     version 1.7.0
//     from Assets/Input/Home/HomeInputAsset.inputactions
//
...
public partial class @HomeInputAsset: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @HomeInputAsset()
    {
    ...
    {
        private @HomeInputAsset m_Wrapper;
        public HomeActions(@HomeInputAsset wrapper) { m_Wrapper = wrapper; }
